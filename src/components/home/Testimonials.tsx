...
const TestimonialsData = [
  ...
  },
  {
    rating: 5,
    review:
      "Really like the clean design of PostCards. The AI-driven search is impressively accurate, adding a personal dimension to my notes. Fast and very easy to use.",
    name: "John Collins",
    designation: "Engineer & Author",
    profile: "/images/profile.png",
    feature: true,
  ...
  {
    rating: 5,
    review: "Simply brilliant! PostCards has elevated my productivity.",
    name: "Moe Partuj",
    designation: "Student",
